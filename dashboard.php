    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <?php if(@$_GET['q']==0)
                {
                   echo ' <span class="title1" style="margin-left:40%;font-size:30px;color:#fff;"><b>Welcome To Admin Page</b></span>';?>
					    <div class="wrapper">
		...
		<?php
                        ...
                        while($row = mysqli_fetch_array($result)) 
                        {
                            ...
                            $email = $row['email'];
                            $college = $row['post'];
                            echo '<center><h2>ADMIN PROFILE</h2></center><center><b>Name: '.$name.'</center><center>Post: '.$college.'</center><center>'.$email.'</center><center><a title="update profile" href="dashboard.php?q=12"></b><img src="image/edit.png"></a></center>';
                        }
                        $c=0;
                        echo '</table>';
						?>
		...
		<div class="box2">
		lorem2 nfhk eyuo7 lfifkkf
		</div >
		<div class="box3">
		
	   <?php
	                echo ' <center><span class="title1" style="font-size:25px;color:green;"><b>Quiz Titles</b></span></center>';
                        ...
                        while($row = mysqli_fetch_array($result)) 
                        {
                            ...
                            echo '<td><center><b>Title: '.$title.'</center><center>Date: '.$date.'</center></td></br>';
                        }
                        $c=0;
                        echo '</table>';
						?>
               ...
               <?php }
                ...
                <?php 
                    if(@$_GET['q']==1) 
                    {
                        ...
                        <tr><td><center><b>S.N.</b></center></td><td><center><b>Name</b></center></td><td><center><b>Post</b></center></td><td><center><b>Email</b></center></td><td><center><b>Action</b></center></td></tr>';
                        $c=1;
                        while($row = mysqli_fetch_array($result)) 
                        {
                            $name = $row['name'];
				...
				<?php
                    if(@$_GET['q']==12 ) 
                    {
                        echo '<div class="row"><span class="title1" style="margin-left:40%;font-size:30px;color:#fff;"><b>Enter Details</b></span><br /><br />
                        <div class="col-md-3"></div><div class="col-md-6">   
                        <form class="form-horizontal title1" name="form" action="update.php?q=addadmin"  method="POST">
                            <fieldset>
                                ...
                                <div class="form-group">
                                    <label class="col-md-12 control-label" for="total"></label>  
                                    <div class="col-md-12">
                                        <input id="post" name="total" placeholder="Enter Post" class="form-control input-md" type="text">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <label class="col-md-12 control-label" for="right"></label>  
                                    <div class="col-md-12">
                                        <input id="email" name="right" placeholder="Enter Email" class="form-control input-md" min="0" type="text">
                                    </div>
                                </div>
