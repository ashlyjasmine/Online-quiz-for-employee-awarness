...
<style type="text/css">
    ...
    <nav class="navbar navbar-default title1">
        <div class="container-fluid">
			...
			<!--<b> <center><h1>GST BHAVAN</b></br>-->
        <img src="image/label.jpg"><a class="navbar-brand" href="#"><b>Online Quiz System</b></a>
        </div>
...
//next
                    ...
                    if(@$_GET['q']== 'result' && @$_GET['eid']) 
                    {
						...
						echo  '<div class="panel">
                        <center><h1 class="title" style="color:#660033">Answers</h1><center><br /><table class="table table-striped title1" style="font-size:20px;font-weight:1000;">';
						$qs=mysqli_query($con,"select * from questions where eid='$eid'") or die('Error157');
						$no=1;
						while($row=mysqli_fetch_array($qs))
						{
							...
							$qstn=$row['qns'];
							$id=$row['qid'];
							$ans=mysqli_query($con,"select * from answer where qid='$id'");
							$ro=mysqli_fetch_array($ans);
							$ra=$ro['ansid'];
							$op=mysqli_query($con,"select * from options where qid='$id' and optionid='$ra'");
							$pa=mysqli_fetch_array($op);
							$aan=$pa['option'];
							echo '<tr><td>'.$no++.'</td><td>'.$qstn.'</td><td>'.$aan.'</td></tr>';
						}
                    }
                ?>
                ...
                <?php
                    if(@$_GET['q']== 2) 
                    {
                        ...
                        <tr style="color:black;"><td><center><b>S.N.</b></center></td><td><center><b>Date</b></center></td><td><center><b>Quiz</b></center></td><td><center><b>Question Solved</b></center></td><td><center><b>Right</b></center></td><td><center><b>Wrong<b></center></td><td><center><b>Score</b></center></td>';
                        $c=0;
                        while($row=mysqli_fetch_array($q) )
                        {
                        $eid=$row['eid'];
                        ...
                        {  $title=$row['title'];  }
                        $c++;
                        echo '<tr><td><center>'.$c.'</center></td><td><center>'.$d.'</center></td><td><center>'.$title.'</center></td><td><center>'.$qa.'</center></td><td><center>'.$r.'</center></td><td><center>'.$w.'</center></td><td><center>'.$s.'</center></td></tr>';
                        }
                        echo'</table></div>';
                    }
